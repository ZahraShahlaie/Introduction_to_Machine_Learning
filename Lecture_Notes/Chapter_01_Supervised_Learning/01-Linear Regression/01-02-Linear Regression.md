سبز ابی تابع اصلی، زرد و آبی میشه پیش بینی متفاوت هر کدوم بر اساس سه داده متفاوت و قزمز میشه avg  این اف هت ها و مینویسم اگسپکتد fx        منهای f  واقعی ک ببینیم چفد خطا داره میشه بایاس و واریانس هم میشه گفت بر اساس هر داده چفد اون نمودارامم متقاوتند ک خب هر چقد درجه چند جمله ای بیشتر میشه چون مبتونه متقاوت تر باشه واریانسم بالاتر میزه و چون پارامترام بیشتر میشه در این شرایط احتمال  overfitبالا میره 
...
پس میتوان گغف کل خطامون ی بار ممکنه بر اساس مجدود بودن مدلمون بره بالا: چون مدلب پبدا نشه ک خطاش ب نسبت وافعی کمتر شه زورش نرسه مدل خوب پیدا شه و تخمین خوبی باشه و نسبت ب وای وافعی خطای زیادی بشه از اونجایی ک میشه بایاس و توان 2 داره تو فرمول پس تاثیر میزاره _مثلا درجه 3 جوابه ولی شما خط گداشتی خب زورش نمیرسه 
ی وقتایی هم انقدد ک تعداد پارامترامو خیلس زیاد کردم و باعث شده واربانس زیادی داشته باشه ، هر چی مدل پیچیده تر پارامتر بیشتر درنتیحعع واریانس بیشتر 
...
اگر نیاز به توضیحات بیشتری در مورد نحوه محاسبه یا استفاده از این تخمین دارید، حتماً بپرسید!
